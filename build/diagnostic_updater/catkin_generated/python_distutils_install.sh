...
echo_and_run cd "/home/natalia/Scrivania/tb-simulation/ros_ws/src/diagnostic_updater"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/natalia/Scrivania/tb-simulation/ros_ws/src/diagnostic_updater/setup.py" \
    egg_info --egg-base /home/natalia/Scrivania/tb-simulation/ros_ws/build/diagnostic_updater \
    build --build-base "/home/natalia/Scrivania/tb-simulation/ros_ws/build/diagnostic_updater" \
    install \
    --root="${DESTDIR-/}" \
