...
echo_and_run cd "/home/natalia/Scrivania/tb-simulation/ros_ws/src/tb_sim/diagnostic_updater"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/natalia/Scrivania/tb-simulation/ros_ws/build/tb_sim/diagnostic_updater \
    build --build-base "/home/natalia/Scrivania/tb-simulation/ros_ws/build/tb_sim/diagnostic_updater" \
    install \
    --root="${DESTDIR-/}" \
